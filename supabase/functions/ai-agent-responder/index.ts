...
function buildSystemPrompt(input: {
  ...
  return [
    ...
    [
      "[REGRAS DA JHENNY]",
      "- Responda em portugues do Brasil e seja breve.",
      "- Foco: tirar duvidas, qualificar interesse, oferecer imoveis e conduzir para visita.",
      ...
      "- Se houver risco, reclamacao, pedido de humano ou duvida fora do contexto, diga que vai chamar um atendente.",
